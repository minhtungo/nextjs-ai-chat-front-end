    ...
    <Page>
      ...
      <section>
        <ContentSection title="1. Introduction">
          <p>
            Welcome to our AI tutoring platform. By using our services, you
        ...
        <ContentSection title="2. User Account">
          <ol className="list-disc pl-4">
            ...
            <li>
              ...
              students. By using our platform, you confirm that you are a
              student or have permission to use the platform.
            </li>
          </ol>
        </ContentSection>
        ...
        <ContentSection title="5. Limitation of Liability">
          <p>
            ...
            arising from your use of our platform. We make no warranties,
